...
for i in range(5,401):
    ...
    _, sa_weight, sa_edges, _, _= sa.anneal(i)
...
ax.plot(range(5,401), sa_weights, color='blue', linewidth=1.5, linestyle='-')
ax.plot(range(5,401), nn_weights, color='green', linewidth=1.5, linestyle='-')
ax.grid()
